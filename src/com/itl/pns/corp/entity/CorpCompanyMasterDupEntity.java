 ...
 */
@Entity
@Table(name = "CORP_COMPANY_MASTER_DUP")
public class CorpCompanyMasterDupEntity {
	...
	public Integer getMakerValidated() {
	...
	public Integer getCheckerValidated() {
	...
	public String toString() {
		return "CorpCompanyMasterDupEntity [id=" + id + ", companyCode=" + companyCode + ", companyName=" + companyName
				...
				+ ", isCorporate=" + isCorporate + ", branchCode=" + branchCode + ", makerId=" + makerId
				+ ", checkerId=" + checkerId + ", makerValidated=" + makerValidated + ", checkerValidated="
				+ checkerValidated + ", loginId=" + loginId + ", loginType=" + loginType + ", appname=" + appname
				+ ", logoImage=" + logoImage + ", statusName=" + statusName + ", productName=" + productName
				+ ", action=" + action + ", roleName=" + roleName + ", createdByName=" + createdByName + ", role_ID="
				+ role_ID + ", remark=" + remark + ", activityName=" + activityName + ", userAction=" + userAction
				+ ", user_ID=" + user_ID + ", subMenu_ID=" + subMenu_ID + ", userTypes=" + userTypes + ", multiUser="
				+ multiUser + ", statusList=" + statusList + ", userId=" + userId + "]";
	}
