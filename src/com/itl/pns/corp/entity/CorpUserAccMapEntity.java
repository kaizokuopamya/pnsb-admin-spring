...
@Entity
@Table(name = "CORPUSER_ACC_MAP")
public class CorpUserAccMapEntity {

	public CorpUserAccMapEntity() {
		super();
	}

	public CorpUserAccMapEntity(CorpUserAccMapEntity corpUserAccMapEntity) {
		this.corpCompId = corpUserAccMapEntity.corpCompId;
		this.accountNo = corpUserAccMapEntity.accountNo;
		this.corpUserId = corpUserAccMapEntity.corpUserId;
		this.statusId = corpUserAccMapEntity.statusId;
		this.createdon = corpUserAccMapEntity.createdon;
		this.updatedby = corpUserAccMapEntity.updatedby;
	}
