 ...
 */
@Entity
@NamedStoredProcedureQuery(name = "validate_hierarchy", procedureName = "validate_hierarchy", parameters = {
		@StoredProcedureParameter(mode = ParameterMode.IN, type = Integer.class, name = "corpcomid"),
		@StoredProcedureParameter(mode = ParameterMode.OUT, type = Integer.class, name = "statuscode"),
		@StoredProcedureParameter(mode = ParameterMode.OUT, type = String.class, name = "statusmsg") })
@Table(name = "CORP_USERS_TMP")
public class CorpUserEntityTmp {
	...
	Timestamp last_tpin_wrong_attempt;

	@Column(name = "LAST_PWD_WRONG_ATTEMPT")
	Timestamp last_pwd_wrong_attempt;
	...
	Timestamp last_mpin_wrong_attempt;
	...
	@Transient
	List<CorpUserMenuMapEntityTmp> corpUserMenuData;

	@Transient
	List<CorpUserAccMapEntityTmp> corpUserAccData;
	...
	public List<CorpUserMenuMapEntityTmp> getCorpUserMenuData() {
		return corpUserMenuData;
	}

	public void setCorpUserMenuData(List<CorpUserMenuMapEntityTmp> corpUserMenuData) {
		this.corpUserMenuData = corpUserMenuData;
	}

	public List<CorpUserAccMapEntityTmp> getCorpUserAccData() {
		return corpUserAccData;
	}

	public void setCorpUserAccData(List<CorpUserAccMapEntityTmp> corpUserAccData) {
	...
	public Timestamp getLast_tpin_wrong_attempt() {
		return last_tpin_wrong_attempt;
	}

	public void setLast_tpin_wrong_attempt(Timestamp last_tpin_wrong_attempt) {
		this.last_tpin_wrong_attempt = last_tpin_wrong_attempt;
	}

	public Timestamp getLast_pwd_wrong_attempt() {
		return last_pwd_wrong_attempt;
	}

	public void setLast_pwd_wrong_attempt(Timestamp last_pwd_wrong_attempt) {
	...
	public void setLast_mpin_wrong_attempt(Timestamp last_mpin_wrong_attempt) {
