...
@Entity
@Table(name = "CORP_MENU_REQ")
public class CorpMenuReqEntity {
...
//	@Transient
//	private BigDecimal subMenuReqId;

	@Transient
	private BigDecimal[] subMenuReqIdArray;

	@Transient
	private String subMenuName;

	public BigDecimal[] getSubMenuReqIdArray() {
		return subMenuReqIdArray;
	}

	public void setSubMenuReqIdArray(BigDecimal[] subMenuReqIdArray) {
		this.subMenuReqIdArray = subMenuReqIdArray;
	}

//	public BigDecimal getSubMenuReqId() {
//		return subMenuReqId;
//	}
//
//	public void setSubMenuReqId(BigDecimal subMenuReqId) {
//		this.subMenuReqId = subMenuReqId;
//	}
