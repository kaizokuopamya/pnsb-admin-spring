...
public class CorpUserEntity {
	...
	public CorpUserEntity(CorpUserEntity corpUserEntity) {
		this.corpCompId = corpUserEntity.corpCompId;
		this.user_disp_name = corpUserEntity.user_disp_name;
		this.user_name = corpUserEntity.user_name;
		this.user_pwd = corpUserEntity.user_pwd;
		this.createdby = corpUserEntity.createdby;
		this.createdon = corpUserEntity.createdon;
		this.statusid = corpUserEntity.statusid;
		this.appid = corpUserEntity.appid;
		this.lastLoginTime = corpUserEntity.lastLoginTime;
		this.user_type = corpUserEntity.user_type;
		this.first_name = corpUserEntity.first_name;
		this.last_name = corpUserEntity.last_name;
		this.email_id = corpUserEntity.email_id;
		this.country = corpUserEntity.country;
		this.work_phone = corpUserEntity.work_phone;
		this.personal_Phone = corpUserEntity.personal_Phone;
		this.nationalId = corpUserEntity.nationalId;
		this.passport = corpUserEntity.passport;
		this.aadharCardNo = corpUserEntity.aadharCardNo;
		this.boardResolution = corpUserEntity.boardResolution;
		this.user_image = corpUserEntity.user_image;
		this.tpin = corpUserEntity.tpin;
		this.passportNumber = corpUserEntity.passportNumber;
		this.nationalIdNumber = corpUserEntity.nationalIdNumber;
		this.tpin_status = corpUserEntity.tpin_status;
		this.rights = corpUserEntity.rights;
		this.pkiStatus = corpUserEntity.pkiStatus;
		this.tpin_wrong_attempt = corpUserEntity.tpin_wrong_attempt;
		this.city = corpUserEntity.city;
		this.wrong_pwd_attempt = corpUserEntity.wrong_pwd_attempt;
		this.pwd_status = corpUserEntity.pwd_status;
		this.otherDoc = corpUserEntity.otherDoc;
		this.certificate_incorporation = corpUserEntity.certificate_incorporation;
		this.state = corpUserEntity.state;
		this.designation = corpUserEntity.designation;
		this.last_tpin_wrong_attempt = corpUserEntity.last_tpin_wrong_attempt;
		this.last_pwd_wrong_attempt = corpUserEntity.last_pwd_wrong_attempt;
		this.mpin = corpUserEntity.mpin;
		this.mpin_wrong_attempt = corpUserEntity.mpin_wrong_attempt;
		this.last_mpin_wrong_attempt = corpUserEntity.last_mpin_wrong_attempt;
		this.pancard = corpUserEntity.pancard;
		this.pancardNumber = corpUserEntity.pancardNumber;
		this.updatedby = corpUserEntity.updatedby;
		this.transMaxLimit = corpUserEntity.transMaxLimit;
		this.updatedOn = corpUserEntity.updatedOn;
		this.mobRegStatus = corpUserEntity.mobRegStatus;
		this.ibRegStatus = corpUserEntity.ibRegStatus;
		this.parentRoleId = corpUserEntity.parentRoleId;
		this.parentId = corpUserEntity.parentId;
		this.dob = corpUserEntity.dob;
		this.parentUserName = corpUserEntity.parentUserName;
		this.corpRoleId = corpUserEntity.corpRoleId;
		this.rrn = corpUserEntity.rrn;
		this.parentRrn = corpUserEntity.parentRrn;
		this.remark = corpUserEntity.remark;
		this.wrongAttemptSoftToken = corpUserEntity.wrongAttemptSoftToken;
		this.ogstatus = corpUserEntity.ogstatus;
	}
	...
	public String toString() {
		return "CorpUserEntity [id=" + id + ", corpCompId=" + corpCompId + ", user_disp_name=" + user_disp_name
				...
				+ ", wrongAttemptSoftToken=" + wrongAttemptSoftToken + ", ogstatus=" + ogstatus + ", passportImg="
				+ passportImg + ", userStringImage=" + userStringImage + ", boardResolutionImg=" + boardResolutionImg
				...
				+ ", userNameList=" + userNameList + ", branchCode=" + branchCode + ", isEdited=" + isEdited + "]";
	}
