...
// */
//@Entity
//@Table(name = "CORP_COMPANY_MASTER_TMP")
//public class CorpCompanyMasterEntityTmp {
//
...
//		return "CorpCompanyMasterEntityTmp [id=" + id + ", companyCode=" + companyCode + ", companyName=" + companyName
...
//				+ ", corporateType=" + corporateType + ", pancardNo=" + pancardNo
//				+ ", updatedOn=" + updatedOn
...
//				+ ", isCorporate=" + isCorporate + ", branchCode=" + branchCode + ", loginId=" + loginId
//				+ ", loginType=" + loginType + ", appname=" + appname + ", logoImage=" + logoImage + ", statusName="
//				+ statusName + ", productName=" + productName + ", action=" + action + ", roleName=" + roleName
//				+ ", createdByName=" + createdByName + ", role_ID=" + role_ID + ", remark=" + remark + ", activityName="
//				+ activityName + ", userAction=" + userAction + ", user_ID=" + user_ID + ", subMenu_ID=" + subMenu_ID
//				+ ", userTypes=" + userTypes + ", multiUser=" + multiUser + ", statusList=" + statusList + ", userId="
//				+ userId + "]";
//	}
//}
