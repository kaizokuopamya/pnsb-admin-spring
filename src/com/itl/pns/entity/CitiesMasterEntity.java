...
@Entity
@Table(name = "CITIESMASTER")
public class CitiesMasterEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "citiesmaster_id_SEQ")
	@SequenceGenerator(name = "citiesmaster_id_SEQ", sequenceName = "citiesmaster_id_SEQ", allocationSize = 1)
	BigDecimal id;
