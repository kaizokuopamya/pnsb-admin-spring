...
public class LanguageJson {
	...
	@Column(name = "LANGUAGECODEDESCENC")
	String languagecodedescenc;
	...
	public String getLanguagecodedescenc() {
		return languagecodedescenc;
	}

	public void setLanguagecodedescenc(String languagecodedescenc) {
		this.languagecodedescenc = languagecodedescenc;
	}
