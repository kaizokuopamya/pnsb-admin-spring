...
@Entity
@Table(name = "EASE5_QUICK_ACCESS")
public class Ease5QuickAccessEntity {
	
	@Id
	@Column(name = "ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "EASE5_QUICK_ACCESS_SEQ")
	@SequenceGenerator(name = "EASE5_QUICK_ACCESS_SEQ", sequenceName = "EASE5_QUICK_ACCESS_SEQ", allocationSize = 1)
	private Integer id;
