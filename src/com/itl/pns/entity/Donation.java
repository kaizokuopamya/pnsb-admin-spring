...
@Entity
@Table(name = "DONATION_PRD")
public class Donation {

	@javax.persistence.Id
	@Column(name = "ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "donation_prd_id_SEQ")
	@SequenceGenerator(name = "donation_prd_id_SEQ", sequenceName = "donation_prd_id_SEQ", allocationSize = 1)
