...
@Entity
@Table(name = "CALCULATORMASTER_PRD")
public class CalculatorMasterEntity {

	@javax.persistence.Id
	@Column(name = "ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "calculatormaster_prd_id_SEQ")
	@SequenceGenerator(name = "calculatormaster_prd_id_SEQ", sequenceName = "calculatormaster_prd_id_SEQ", allocationSize = 1)
	...
	@Column(name = "CALCULATORDESCRIPTION")
