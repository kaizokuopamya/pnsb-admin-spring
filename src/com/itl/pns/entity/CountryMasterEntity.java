...
public class CountryMasterEntity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "countrymaster_id_SEQ")
	@SequenceGenerator(name = "countrymaster_id_SEQ", sequenceName = "countrymaster_id_SEQ", allocationSize = 1)
	BigDecimal id;
