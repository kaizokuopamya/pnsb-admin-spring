...
@Entity
@Table(name = "EASE5_MORE_SUB_ICONS")
public class Ease5MoreSubIconsEntity {

	@Id
	@Column(name = "ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "EASE5_MORE_SUB_ICONS_SEQ")
	@SequenceGenerator(name = "EASE5_MORE_SUB_ICONS_SEQ", sequenceName = "EASE5_MORE_SUB_ICONS_SEQ", allocationSize = 1)
	private Integer id;
	...
	@Column(name = "MAIN_ICON_ID")	
	private BigDecimal main_icon_id;		
	...
	public BigDecimal getMain_icon_id() {
		return main_icon_id;
	}

	public void setMain_icon_id(BigDecimal main_icon_id) {
		this.main_icon_id = main_icon_id;
	}
