...
public class HolidayEntity {
	...
	@Column(name = "ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "holidaylist_id_SEQ")
	@SequenceGenerator(name = "holidaylist_id_SEQ", sequenceName = "holidaylist_id_SEQ", allocationSize = 1)
