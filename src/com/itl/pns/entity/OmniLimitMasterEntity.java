...
@Entity
@Table(name = "OMNIGLOBALLIMITMASTER")
public class OmniLimitMasterEntity {

	@javax.persistence.Id
	@Column(name = "ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "omnigloballimitmaster_ID_SEQ")
	@SequenceGenerator(name = "omnigloballimitmaster_ID_SEQ", sequenceName = "omnigloballimitmaster_ID_SEQ", allocationSize = 1)
